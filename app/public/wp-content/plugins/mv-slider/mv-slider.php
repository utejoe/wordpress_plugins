...
/**
 * Plugin Name: Uyi Slider
 * Plugin URI: https://www.wordress.org/uyi-slider
 * Description: My Plugins description
 * Version: 1.0
 * Requires at least: 5.6
 * Author: Uyi Obazee
 * Author URI: https://uyiobazeeportfolio.netlify.app
 * License: GPL v2 or later
 * License URI: https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain: uyi-slider
 * Domain Path: /languages
 */

 /*
uyi-slider is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 2 of the License, or
any later version.
uyi-slider is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
GNU General Public License for more details.
You should have received a copy of the GNU General Public License
along with uyi-slider. If not, see https://www.gnu.org/licenses/gpl-2.0.html.
*/
...
if ( ! class_exists( 'MV_Slider' )){
    class MV_Slider{  //you can also check if functions exists with funtion_exists()
        ...
        public function add_menu() {
            ...
            add_submenu_page(
                ...
                'Manage Slides',
                'manage_options',
                'edit.php?post_type=mv-slider', //from the slug of the slider post
            ...
            add_submenu_page(
                ...
                'Add New Slide',
                'manage_options',
                'post-new.php?post_type=mv-slider', //from the slug of the slider post
                null, //we pass null bcos we dont want any content displayed bcos it is already displayed in our upper function
                null,  // for the position
            );
